...
from utils.diagram_generator import generate_ascii_diagram, generate_mermaid_diagram
...
def analyze_commit(repo, commit, output_dir, ascii_only=False, graphviz_format='png', 
    ...
    try:
        ...
        if not ascii_only:
            ...
            generate_mermaid_diagram(snapshot, graphviz_file, all_modules if show_modules else None, graphviz_format)
